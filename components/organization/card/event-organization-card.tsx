            ...
            {events.map((item, index) => {
                return (
                    <Card key={index} className="w-full h-[440px] bg-iDonate-white-space rounded-lg shadow-[1px_1px_1px_3px_rgba(0,0,0,0.03)] border p-7 flex flex-col gap-6 border-iDonate-navy-accent">
                        <CardContent lang="en" className="p-0 pb-4 font-inter flex flex-row items-center justify-between border-b-[2px] border-dashed border-b-iDonate-navy-primary">
                            <Button className="text-xl font-normal bg-transparent hover:bg-iDonate-navy-accent text-iDonate-error rounded-lg">
                                <Trash2 className="fill-iDonate-error w-9 h-9" style={{ width: '25px', height: '25px' }} />
                                Delete Event
                            </Button>

                            <Button className="text-xl font-normal bg-transparent hover:bg-iDonate-navy-accent text-iDonate-navy-primary rounded-lg">
                                <Share2 className="fill-iDonate-navy-primary" style={{ width: '25px', height: '25px' }} />
                                Share Event
                            </Button>
                        </CardContent>
                        ...
                        <div className="flex gap-6">
                            <CardContent className="p-0 w-[300px] h-[300px] rounded-lg">
                                ...
                                <Image width={300} height={300} src={item.image || "https://i.pinimg.com/236x/a9/9e/ff/a99eff25eb1ba71647fcd884c15c035a.jpg"} alt={item.title} className="w-full h-full object-cover rounded-lg" />
